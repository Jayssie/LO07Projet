...
<html>
    <head>
        ...
        <meta name="description" content="Adminisateur du site">
        <title>Adminisateur | BlaBlaCar</title>
        <link rel="stylesheet" type="text/css" href="./CSS/style_index_admin.css"/>
    </head>
    <body>
        <div id="global">
            <div id="entete">
