...
<html>
    <head>
        ...
        <title>Recherche trajet | BlaBlaCar</title>
    ...
    <body>
                ...
                <div id="centre-bis">   
                    <div id='principal_1'>
                        ...
                        <div id='principal_contenue'>
                            <form method="post" id="formtrajet" action="page_resultat_trajet.php"> 
                                <table width="600px" cellspacing=0 cellpadding=5>
                                    <th><h2>Recherche un trajet</h2></th><br/>  
                                    <tr>
                                        <td>                                    
                                ...
                                <table width="600px" cellspacing=0 cellpadding=5>
                                    <th><h2><pre>Date et Horaire ------------------</pre></h2></th>
                                    <tr>
                                        <td>
        ...
        <script>
            ...
            function checksub(input) {
                ...
                if (depart.length == 0 && arv.length == 0) {
                    alert("Rentrer le point depart ou le point arrive svp.");
                } else {
