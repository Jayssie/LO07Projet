    ...
    <body>
                    ...
                    <div id='principal_1'>
                        ...
                        <div id='principal_contenue'>
                            ...
                            if ($resultat) {
                                ...
                                echo"<button id='eff_button' type='button' value='Valider' onclick='checkeff(this)'>Valider</button></tr>";
        ...
        <script>
            ...
            function checkeff(input) {
                document.getElementById('formID').action = "page_effectuer_trajet.php";
